...
//        String regex = "^1(3[0-9]|4[57]|5[0-35-9]|7[01678]|8[0-9])\\d{8}$";
        //改为跟前端一致的----王秋+张作振180418确定的
        String regex = RegexpConstant.REGEXP_PHONE;
        return match(regex, str);
    }
    ...
    public static boolean checkPassword(String str) {
        return match(RegexpConstant.REGEXP_PASSWORD, str);
    }
     ...
     *
     * @param str
     * @param type 1身份证  2其它证件
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean IsIDcard(String str,Integer type) {
        String regex;
        if(type == 1){
            regex = RegexpConstant.REGEXP_ID_CARD_SFZ;
        }else {
            regex = RegexpConstant.REGEXP_ID_CARD_OTH;
        }
        return match(regex, str);
    }
    /**
